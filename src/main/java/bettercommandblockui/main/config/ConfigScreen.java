...
public class ConfigScreen extends Screen {
    ...
    public ConfigScreen(Screen parent, int width, int height) {
    ...
    private void setup() {
        ...
        CheckboxWidget.Callback callback = this::checkboxCallback;
        ...
        indentationFac.setChangedListener(input -> {
            try {
                int inputInt = Math.clamp(Integer.parseInt(input), 1, 16);
        ...
        wraparound.setChangedListener(input -> {
            try {
                int inputInt = Math.clamp(Integer.parseInt(input), 10, 6400);
        ...
        scrollSpeedX.setChangedListener(input -> {
            try {
                int inputInt = Math.clamp(Integer.parseInt(input), 1, 64);
    ...
    public void close() {
        if (parent != null && client != null) {
            ...
            if (parent instanceof AbstractBetterCommandBlockScreen abstractBetterCommandBlockScreen) {
                abstractBetterCommandBlockScreen.returnFromConfig();
            }
        }
    }
    ...
    public void checkboxCallback(CheckboxWidget source, boolean checked) {
        if (source.equals(newLinePreOpen)) {
            BetterCommandBlockUI.setConfig(BetterCommandBlockUI.VAR_NEWLINE_PRE_OPEN_BRACKET, String.valueOf(checked));
        }
        if (source.equals(newLinePostOpen)) {
            BetterCommandBlockUI.setConfig(BetterCommandBlockUI.VAR_NEWLINE_POST_OPEN_BRACKET, String.valueOf(checked));
        }
        if (source.equals(newLinePreClose)) {
            BetterCommandBlockUI.setConfig(BetterCommandBlockUI.VAR_NEWLINE_PRE_CLOSE_BRACKET, String.valueOf(checked));
        }
        if (source.equals(newLinePostClose)) {
            BetterCommandBlockUI.setConfig(BetterCommandBlockUI.VAR_NEWLINE_POST_CLOSE_BRACKET, String.valueOf(checked));
        }
        ...
        if (source.equals(newLinePostComma)) {
            BetterCommandBlockUI.setConfig(BetterCommandBlockUI.VAR_NEWLINE_POST_COMMA, String.valueOf(checked));
        }
        if (source.equals(formatStrings)) {
            BetterCommandBlockUI.setConfig(BetterCommandBlockUI.VAR_FORMAT_STRINGS, String.valueOf(checked));
        }
        if (source.equals(ignoreEnter)) {
            BetterCommandBlockUI.setConfig(BetterCommandBlockUI.VAR_IGNORE_ENTER, String.valueOf(checked));
        }
        if (source.equals(autosave)) {
            BetterCommandBlockUI.setConfig(BetterCommandBlockUI.VAR_AUTOSAVE, String.valueOf(checked));
        }
        if (source.equals(avoidDoubleNewline)) {
            BetterCommandBlockUI.setConfig(BetterCommandBlockUI.VAR_AVOID_DOUBLE_NEWLINE, String.valueOf(checked));
        }
