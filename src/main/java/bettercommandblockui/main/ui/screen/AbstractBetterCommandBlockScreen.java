...
public abstract class AbstractBetterCommandBlockScreen extends Screen {
    ...
    public void openConfig() {
        ...
        client.setScreen(new ConfigScreen(this, width, height));
    }
    ...
    public boolean mouseClicked(Click click, boolean doubled) {
        if (showSideWindow && sideWindow.mouseClicked(click, doubled)) {
            return true;
        }
        if (commandSuggestor.isOpen() && commandSuggestor.mouseClicked(click)) {
            return true;
        }
    ...
    public boolean mouseDragged(Click click, double deltaX, double deltaY) {
        if (click.button() == 0) {
            if (showSideWindow && sideWindow.mouseDragged(click, deltaX, deltaY)) {
                return true;
            }
            if (showOutput) {
    ...
    public boolean mouseReleased(Click click) {
        if (showSideWindow && sideWindow.mouseReleased(click)) {
            return true;
        }
        if (click.button() == 0) {
            if (showOutput) {
    ...
    public boolean keyPressed(KeyInput input) {
        if (showSideWindow && sideWindow.isFocused() && sideWindow.keyPressed(input)) {
            return true;
        }
        ...
        if (keyCode == 258 && sideWindow.isFocused()) {
            return true;
        }
    ...
    public boolean charTyped(CharInput input) {
        if (showSideWindow && sideWindow.charTyped(input)) {
            return true;
        }
        if (showOutput) {
            return false;
