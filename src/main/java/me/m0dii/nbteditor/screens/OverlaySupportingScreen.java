...
import me.m0dii.nbteditor.screens.widgets.InitializableOverlay;
...
public class OverlaySupportingScreen extends TickableSupportingScreen {
    ...
    public static <T extends Drawable & Element> T setOverlayStatic(T overlay, double z) {
        return ((OverlaySupportingScreen) MiscUtil.client.currentScreen).setOverlay(overlay, z);
    }
    ...
    public static <T extends Screen> T setOverlayScreenStatic(T overlay, double z) {
        return ((OverlaySupportingScreen) MiscUtil.client.currentScreen).setOverlayScreen(overlay, z);
    }
    ...
    public final void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (overlay != null) {
            ...
            ((Drawable) overlay).render(drawContext, mouseX, mouseY, delta);
            if (translated) {
                matrices.pop();
            }
        }
