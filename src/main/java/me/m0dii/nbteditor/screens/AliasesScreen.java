...
import me.m0dii.nbteditor.multiversion.commands.ClientCommandManager;
import me.m0dii.nbteditor.screens.ConfigScreen.Alias;
...
public class AliasesScreen extends TickableSupportingScreen {
    ...
    public AliasesScreen(Screen parent) {
        ...
        this.parent = parent;
        this.config = new ConfigList(TextInst.translatable("nbteditor.config.aliases")
                .append(" - ")
