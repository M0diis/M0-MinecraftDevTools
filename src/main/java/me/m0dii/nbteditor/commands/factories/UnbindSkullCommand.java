...
import me.m0dii.nbteditor.tagreferences.BlockTagReferences;
        ...
        builder.executes(context -> {
            NBTReference.getReference(SKULL_FILTER, false, ref -> {
                ...
                if (profile.isEmpty() || profile.get().getProperties().isEmpty()) {
                    MiscUtil.client.player.sendMessage(TextInst.translatable("nbteditor.unbind_skull.no_textures"), false);
                    return;
                }
