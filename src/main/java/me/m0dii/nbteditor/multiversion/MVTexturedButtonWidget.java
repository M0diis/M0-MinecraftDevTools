...
class MVTexturedButtonWidget extends ButtonWidget {
    ...
    public MVTexturedButtonWidget(int x, int y, int width, int height, int u, int v, int hoveredVOffset,
                                  Identifier texture, int textureWidth, int textureHeight, PressAction pressAction) {
    ...
    public void drawTexture(DrawContext context, Identifier texture, int x, int y, int u, int v, int hoveredVOffset,
        ...
        DrawableHelper.drawTexture(DrawableHelper.getMatrices(context), texture, x, y, u, i, width, height, textureWidth, textureHeight);
    }
