...
package me.m0dii.nbteditor.multiversion.commands;
...
public final class ClientCommandManager {
    ...
    public static void createDispatcher() {
        ...
        CommandRegistryAccess registryAccess = CommandRegistryAccess.of(
                MiscUtil.client.getNetworkHandler().getRegistryManager(),
                MiscUtil.client.getNetworkHandler().getEnabledFeatures());
    ...
    public static void reregisterClientCommands() {
        if (MiscUtil.client.getNetworkHandler() == null) {
            return;
        }

        createDispatcher();
        MiscUtil.client.getNetworkHandler().onCommandTree(lastCommandPacket);
    }
}
