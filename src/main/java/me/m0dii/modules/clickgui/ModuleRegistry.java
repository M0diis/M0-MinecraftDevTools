...
public class ModuleRegistry {
    ...
    public static synchronized void initializeCategories() {
        ...
        safeAdd(hud, MacroKeybindHudModule.INSTANCE);
        safeAdd(hud, PendingMacrosHudModule.INSTANCE);
        safeAdd(hud, MacroHudModule.INSTANCE);
        ...
        safeAdd(utilities, FastBlockPlacementModule.INSTANCE);
        safeAdd(utilities, ReachModule.INSTANCE);
