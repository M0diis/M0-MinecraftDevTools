...
1. Download the latest release from the [GitHub Releases](https://github.com/mod-nerds-inc/middle-click-fix/releases) page or build from source (see below).
